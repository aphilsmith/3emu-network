...
contract 3EMUToken is StandardToken {
    ...
    uint256 public constant TOKEN_FIRST_EXCHANGE_RATE = 200; // 175 3EMU per 1 ETH
    uint256 public constant TOKEN_SECOND_EXCHANGE_RATE = 250; // 125 3EMU per 1 ETH
    uint256 public constant TOKEN_CREATION_CAP = 10.0 * (10**6) * 10**decimals; // 10.0 million 3EMU
    ...
    event LogRedeem3EMU(address indexed _to, uint256 _value, bytes32 _nimiqAddress);
    ...
    /// @dev Redeems 3EMU and records the 3EmU address of the sender
